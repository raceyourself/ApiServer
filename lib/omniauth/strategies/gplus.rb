# Modified to support offline access
module OmniAuth
  module Strategies
    class Gplus < OAuth2
      ...
      option :authorize_options, [:scope, :request_visible_actions, :access_type]
      ...
      def custom_parameters(params)
        ["scope", "client_options", "state", "request_visible_actions", "access_type"].each { |k| add_key_to_params(params, k) }
      end
